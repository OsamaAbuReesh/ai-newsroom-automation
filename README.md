...
### 🔗 Workflow Structure:
**Webhook** (POST/webhook/edit-article) => **Function** (Generate Editorial Prompt) => **Basic LLM Chain** (OpenAI Chat Model) => **Respond To Webhook**
...
📸 **LLM Output Sample**  
![LLM Output Sample](n8n-workflow/screenshots/llm_output_sample.png)
